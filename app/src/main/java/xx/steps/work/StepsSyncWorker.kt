...
class StepsSyncWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        // is how this run came to report "no sensor" for a phone that had one and had simply not
        ...
        when (StepAccessState.access.value) {
            StepAccess.PERMISSION_MISSING, StepAccess.SENSOR_MISSING -> return Result.success()
        ...
        val reading = sensor.readOnce() ?: return Result.success()
